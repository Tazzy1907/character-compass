...
class CharacterProfile(BaseModel):
    ...
    personality: Optional[str] = Field(default="", description="The personality of the character")
    appearance: Optional[str] = Field(default="", description="The appearance of the character")
    backstory: Optional[str] = Field(default="", description="The backstory of the character")
    relationships: Optional[list[str]] = Field(default_factory=list, description="The relationships of the character")
    goals: Optional[list[str]] = Field(default_factory=list, description="The goals of the character")
    motivations: Optional[list[str]] = Field(default_factory=list, description="The motivations of the character")
